...
<table border="1" width="100%" cellpadding="10" style="border-collapse: collapse;">
    ...
    <?php foreach($produtos as $p): ?> // foreach é usado para iterar sobre o array de produtos e exibir cada um em uma linha da tabela
    <tr>
        <td><?= $p['id'] ?></td>
        ...
        <td>
            ...
            <form action="exclui.php" method="POST" style="display:inline" onsubmit="return confirm('Excluir?')">
                // onsubmit é um evento do HTML que é acionado quando o formulário é enviado    
